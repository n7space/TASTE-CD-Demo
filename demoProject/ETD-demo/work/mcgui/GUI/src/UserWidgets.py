...
class Poll(UserWidgetsCommon.TM):
    ''' User widget for telemetry Poll '''
    name = 'Poll'  # name for the combo button in the GUI

    def __init__(self, parent=None):
        ''' Initialise the widget '''
        super().__init__(parent)
        self.parent = parent
        self.setWindowTitle("TC Poll")
        self.show()
    ...
    def editorIsApplicable(editor):
        ''' Do not change this function '''
        return editor.messageName == "Poll"
